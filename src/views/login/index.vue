        ...
        <div class="login-content-main">
          <div class="login-icon-group">
            <div class="login-icon-group-title">
              <img :src="logoMini" />
<!--              <div class="login-icon-group-title-text font25">{{ getThemeConfig.globalTitle }}</div>-->
							<div class="login-icon-group-title-text font25">P2后台管理系统</div>
            </div>
          </div>
          <div v-if="!isScan">
